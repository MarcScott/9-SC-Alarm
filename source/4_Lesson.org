...
- Lasstly uncheck the box, so that we can place components ourselves.
...
- A gold badge will be awarded if you create a viable PCB no larger than 200mm by 200mm, without using jump wires.
- A platinum badge will be awaded if you create a viable PCB no larger than 100mm by 100mm, without using jump wires.
